...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        if (self.x, self.y) not in self.cleanTiles:
            self.cleanTiles.append((self.x, self.y))
...
# showPlot1('Plot_Title_1', 'Horizontal_Axis_Label', 'Vertical_Axis_Label')
showPlot2('Plot_Title_2', 'Horizontal_Axis_Label', 'Vertical_Axis_Label')
